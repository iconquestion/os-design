...
PostOffice::PostOffice(NetworkAddress addr, double reliability,
    ...
    network = new Network(addr, reliability, orderability, ReadAvail, WriteDone,
                          (_int)this);
...
void
PostOffice::Receive(int box, PacketHeader *pktHdr, MailHeader *mailHdr,
                    char *data) {
